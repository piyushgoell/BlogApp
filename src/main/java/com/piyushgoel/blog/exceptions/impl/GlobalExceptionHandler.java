...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler{
    ...
    public ResponseEntity<Object> handleUncaughtException(final Exception ex, final ServletWebRequest request) {
        log(ex, request);
        final AppException appException = AppExceptionBuilder.build(Exception.class.getSimpleName(),HttpStatus.INTERNAL_SERVER_ERROR.getReasonPhrase(),HttpStatus.INTERNAL_SERVER_ERROR);
    ...
    public ResponseEntity<Object> handleCustomUncaughtBusinessException(final BusinessException ex,
        ...
        log(ex, request);
        final AppException appException = AppExceptionBuilder.build(ex.getCode(), ex.getMessage(), ex.getHttpStatus());
        return ResponseEntity.status(ex.getHttpStatus()).body(appException);
    }
    ...
    public ResponseEntity<Object> handleCustomUncaughtResourceNotFoundException(final ResourceNotFoundException ex,
                                                                        final ServletWebRequest request) {
       //  log(ex, request);
        final AppException appException = AppExceptionBuilder.build(ex.getCode(), ex.getMessage(), ex.getHttpStatus());
        return ResponseEntity.status(ex.getHttpStatus()).body(appException);
    ...
    public ResponseEntity<Object> handleCustomUncaughtApplicationException(final ApplicationException ex,
                                                                           final ServletWebRequest request) {
        log(ex, request);
        final AppException appException = AppExceptionBuilder.build(ex.getCode(), ex.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(appException);
    }
    ...
    public ResponseEntity<Object> handleConstraintViolationException(final ConstraintViolationException ex,
        ...
        final AppException appException = AppExceptionBuilder.build(ConstraintViolationException.class.getSimpleName(),
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(final HttpMessageNotReadableException ex,
        ...
        final AppException appException = AppExceptionBuilder.build(HttpMessageNotReadableException.class.getSimpleName(), ex.getMessage(),
    ...
    protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(
        ...
        log(ex, (ServletWebRequest) request);
        final AppException appException = AppExceptionBuilder.build(HttpRequestMethodNotSupportedException.class.getSimpleName(), ex.getMessage(),
                HttpStatus.METHOD_NOT_ALLOWED);
        return ResponseEntity.status(HttpStatus.METHOD_NOT_ALLOWED).body(appException);
    }
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(final MethodArgumentNotValidException ex,
        ...
        final List<InvalidParameter> invalidParameters = ex.getBindingResult().getFieldErrors().stream()
                .map(fieldError -> InvalidParameter.builder()
                        .parameter(fieldError.getField())
                        .message(fieldError.getDefaultMessage())
                        .build()).collect(toList());

        final AppException appException = AppExceptionBuilder.build(MethodArgumentNotValidException.class.getSimpleName(),
                HttpStatus.BAD_REQUEST.getReasonPhrase(), HttpStatus.BAD_REQUEST, invalidParameters);
    ...
    protected ResponseEntity<Object> handleServletRequestBindingException(final ServletRequestBindingException ex,
        ...
        final InvalidParameter missingParameterObject = InvalidParameter.builder()
                .parameter(missingParameter)
                .message(format("Missing %s parameter with name '%s'", missingParameterType, missingParameter))
                .build();

        final AppException appException = AppExceptionBuilder.build(ServletRequestBindingException.class.getSimpleName(),
                HttpStatus.BAD_REQUEST.getReasonPhrase(), HttpStatus.BAD_REQUEST, singletonList(missingParameterObject));
    ...
    protected ResponseEntity<Object> handleTypeMismatch(final TypeMismatchException ex, final HttpHeaders headers,
        ...
        final AppException appException = AppExceptionBuilder.build(TypeMismatchException.class.getSimpleName(),
